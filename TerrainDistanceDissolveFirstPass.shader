...
Shader "Custom/TerrainDistanceDissolveFirstPass" {
    Properties {
    ...
    SubShader {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			float ns = _NoiseAmount * ( noise(_NoiseOffset + _NoiseScale * IN.worldPos.xyz) - _NoiseThreshold );
    ...
    Dependency "AddPassShader" = "Custom/TerrainOcclusionDissolveAddPass"
