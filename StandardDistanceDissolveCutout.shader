...
Shader "Custom/StandardDistanceDissolveCutout" {
	Properties {
	...
	SubShader {
		...
		#pragma surface surf Standard vertex:vert fullforwardshadows addshadow alphatest:_Cutoff
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			o.Emission = tex2D (_EmissionTex, IN.uv_MainTex) * _EmissionTint;
			o.Alpha = c.a;
		}
		ENDCG
	}
